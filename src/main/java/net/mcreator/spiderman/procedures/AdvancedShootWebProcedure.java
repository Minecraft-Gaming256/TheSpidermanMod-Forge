...
public class AdvancedShootWebProcedure {
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SpidermanMod.LOGGER.warn("Failed to load dependency entity for procedure AdvancedShootWeb!");
			return;
		}
		...
		if ((entity.isSneaking())) {
			if (entity instanceof LivingEntity) {
				...
				if (!_ent.world.isRemote()) {
					SwingWebItem.shoot(_ent.world, (LivingEntity) entity, new Random(), (float) 2, (float) 0, (int) 0);
				}
			}
			{
			...
			if (entity instanceof LivingEntity) {
				Entity _ent = entity;
				if (!_ent.world.isRemote()) {
					WebItem.shoot(_ent.world, (LivingEntity) entity, new Random(), (float) 2, (float) 15, (int) 0);
				}
			}
			{
				ItemStack _ist = ((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY);
