...
public class RushedChiseledStoneBrickBlock extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:rushed_chiseled_stone_brick")
	public static final Block block = null;
	public RushedChiseledStoneBrickBlock(SpidermanModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rushed_chiseled_stone_brick");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("-Rushed"));
		}
