...
public class BuriedMeteorStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("buried_meteor"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("spiderman:buried_meteor"), configuredFeature);
		}
	}
	@SubscribeEvent
