...
@OnlyIn(Dist.CLIENT)
public class VenomSymbioteRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(VenomSymbioteEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelsymbiote(), 0.3f) {
					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("spiderman:textures/symbiotevenom.png");
					}
				};
			});
		}
