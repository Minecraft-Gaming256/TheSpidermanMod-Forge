...
package net.mcreator.spiderman.entity;
...
import net.mcreator.spiderman.procedures.RadioActiveSpiderOnEntityTickUpdateProcedure;
import net.mcreator.spiderman.itemgroup.ItemsItemGroup;
import net.mcreator.spiderman.item.RadioActiveSplatItem;
import net.mcreator.spiderman.entity.renderer.RadioActiveSpiderRenderer;
...
public class RadioActiveSpiderEntity extends SpidermanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(0.8f, 0.8f)).build("radio_active_spider").setRegistryName("radio_active_spider");
	public RadioActiveSpiderEntity(SpidermanModElements instance) {
		super(instance, 13);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RadioActiveSpiderRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16711936, new Item.Properties().group(ItemsItemGroup.tab))
				.setRegistryName("radio_active_spider_spawn_egg"));
	}
	...
	public static class CustomEntity extends SpiderEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(3, new NearestAttackableTargetGoal(this, IronGolemEntity.class, true, true));
			this.targetSelector.addGoal(4, new NearestAttackableTargetGoal(this, AnimalEntity.class, true, true));
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, VenomSymbioteEntity.CustomEntity.class, true, true));
		}
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(RadioActiveSplatItem.block, (int) (1)));
		}
		...
		public void baseTick() {
			...
			Entity entity = this;
			{
				...
				RadioActiveSpiderOnEntityTickUpdateProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
