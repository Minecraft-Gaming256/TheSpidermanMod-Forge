...
import net.mcreator.spiderman.entity.renderer.RadioactiveSlimeRenderer;
...
public class RadioactiveSlimeEntity extends SpidermanModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1f, 1f)).build("radioactive_slime").setRegistryName("radioactive_slime");
	public RadioactiveSlimeEntity(SpidermanModElements instance) {
		super(instance, 17);
		FMLJavaModLoadingContext.get().getModEventBus().register(new RadioactiveSlimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711936, -10027162, new Item.Properties().group(ItemsItemGroup.tab))
				.setRegistryName("radioactive_slime_spawn_egg"));
	}
