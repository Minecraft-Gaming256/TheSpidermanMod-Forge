...
public class RiotsHandItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:riots_hand")
	public static final Item block = null;
	public RiotsHandItem(SpidermanModElements instance) {
		super(instance, 10);
	}
