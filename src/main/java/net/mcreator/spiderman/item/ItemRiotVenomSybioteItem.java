...
public class ItemRiotVenomSybioteItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:riot_symbiote")
	public static final Item block = null;
	public ItemRiotVenomSybioteItem(SpidermanModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("-Riot"));
		}
	}
}
