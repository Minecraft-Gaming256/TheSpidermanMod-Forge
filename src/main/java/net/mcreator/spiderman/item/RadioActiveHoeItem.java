...
public class RadioActiveHoeItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:radio_active_hoe")
	public static final Item block = null;
	public RadioActiveHoeItem(SpidermanModElements instance) {
		super(instance, 28);
	}
	...
	public void initElements() {
		...
		}, 0, -3f, new Item.Properties().group(ItemsItemGroup.tab).isImmuneToFire()) {
			@Override
		...
		}.setRegistryName("radio_active_hoe"));
	}
}
