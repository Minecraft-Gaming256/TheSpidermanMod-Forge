...
public class BlueSpidermanScalesItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:blue_spiderman_scales")
	public static final Item block = null;
	public BlueSpidermanScalesItem(SpidermanModElements instance) {
		super(instance, 51);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("blue_spiderman_scales");
		}
