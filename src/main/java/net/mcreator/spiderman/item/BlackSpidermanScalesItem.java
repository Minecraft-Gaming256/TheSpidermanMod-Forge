...
public class BlackSpidermanScalesItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:black_spiderman_scales")
	public static final Item block = null;
	public BlackSpidermanScalesItem(SpidermanModElements instance) {
		super(instance, 52);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("black_spiderman_scales");
		}
