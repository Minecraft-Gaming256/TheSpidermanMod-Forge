...
public class MetalJarItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:metal_jar")
	public static final Item block = null;
	public MetalJarItem(SpidermanModElements instance) {
		super(instance, 37);
	}
