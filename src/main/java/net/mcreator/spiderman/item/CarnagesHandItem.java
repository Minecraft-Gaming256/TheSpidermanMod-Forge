...
public class CarnagesHandItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:carnages_hand")
	public static final Item block = null;
	public CarnagesHandItem(SpidermanModElements instance) {
		super(instance, 11);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("-Sneak+Right-Click  To Switch Tool"));
		}
	}
}
