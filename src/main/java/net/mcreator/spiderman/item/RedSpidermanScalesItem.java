...
public class RedSpidermanScalesItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:red_spiderman_scales")
	public static final Item block = null;
	public RedSpidermanScalesItem(SpidermanModElements instance) {
		super(instance, 50);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("red_spiderman_scales");
		}
