...
public class LeatherScaleItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:leather_scale")
	public static final Item block = null;
	public LeatherScaleItem(SpidermanModElements instance) {
		super(instance, 49);
	}
