...
public class VenoriteAxeItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:venorite_axe")
	public static final Item block = null;
	public VenoriteAxeItem(SpidermanModElements instance) {
		super(instance, 31);
	}
