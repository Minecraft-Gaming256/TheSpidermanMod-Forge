...
public class ItemVenomSymbioteItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:item_venom_symbiote")
	public static final Item block = null;
	public ItemVenomSymbioteItem(SpidermanModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("item_venom_symbiote");
		}
