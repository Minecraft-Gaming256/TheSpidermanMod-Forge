...
public class RadioActivePickaxeItem extends SpidermanModElements.ModElement {
	@ObjectHolder("spiderman:radio_active_pickaxe")
	public static final Item block = null;
	public RadioActivePickaxeItem(SpidermanModElements instance) {
		super(instance, 26);
	}
	...
	public void initElements() {
		...
		}, 1, -3f, new Item.Properties().group(ItemsItemGroup.tab).isImmuneToFire()) {
			@Override
		...
		}.setRegistryName("radio_active_pickaxe"));
	}
}
